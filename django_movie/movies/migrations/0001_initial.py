# Generated by Django 3.1.2 on 2021-05-29 21:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='amount in dollars', verbose_name='Fees in the USA')),
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='amount in dollars', verbose_name='Fees in the world')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.Actor', verbose_name='Stage director')),
